...
namespace
{
	...
	private:
		 ...
		 */
		void print(const std::wstring &a, const std::wstring &sep = L"")
		{
			wbuffer << L"\"";
			wbuffer << a;
			wbuffer << L"\"";
		 ...
		 * @param sep The separator string to print after the string.
		 */
		void print(const wchar_t *a, const std::wstring &sep = L"")
		{
			wbuffer << L"\"";
			wbuffer << a;
			wbuffer << L"\"";
	...
	public:
		void setOutputDest(OutputDest _dest)
		{
			dest = _dest;
		}
